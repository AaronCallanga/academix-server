...
public interface DocumentRequestAuditService {
    ...
    Page<DocumentRequestAudit> getAllDocumentRequestsByRequestId(Long documentRequestId, int page, int size, String sortDirection, String sortField); // Should be paged by timeStamp latest as default
